...
import { jobs, JobStatus } from '@/data/jobs';

const statusConfig: Record<JobStatus, { label: string; className: string; description: string }> = {
...
const JobDetails = () => {
  ...
  const handleWhatsApp = () => {
    if (job.contact.whatsapp) {
      ...
      window.open(`https://wa.me/${job.contact.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent(message)}`, '_blank');
    }
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${job.title} job at ${job.facility} in ${job.location}. ${job.salary || 'Competitive salary'}. Apply now on Tuma Job.`}
        />
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap items-center gap-4 text-muted-foreground">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{job.facility}</span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="sticky top-24">
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    {job.contact.email && (
                      <Button
                        ...
                        disabled={!isActive}
                      >
                        <a href={`mailto:${job.contact.email}?subject=Application: ${job.title}`}>
                ...
                <div className="bg-accent/10 rounded-xl border border-accent/20 p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Generate a professional cover letter tailored to this position in seconds.
                  </p>
